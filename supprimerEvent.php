<?php
    ...
    $eventList = $pdo->query("SELECT id_evenement, titre FROM evenement ORDER BY date_evenement DESC")->fetchAll(PDO::FETCH_ASSOC);

    if ($_SERVER["REQUEST_METHOD"] === "POST") {
        // Suppression de l’événement
        if (isset($_POST['id_evenement'])) {
            $requete = $pdo->prepare("DELETE FROM evenement WHERE id_evenement = :id_evenement");
